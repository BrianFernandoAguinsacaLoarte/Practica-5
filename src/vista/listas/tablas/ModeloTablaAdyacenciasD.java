 ...
 * @author Usuario iTC
 */
public class ModeloTablaAdyacenciasD extends AbstractTableModel {

    private GrafoEtiquetadoDirigido<Telefonia> grafo; 
    ...
    public GrafoEtiquetadoDirigido<Telefonia> getGrafo() {
        return grafo;
    }

    public void setGrafo(GrafoEtiquetadoDirigido<Telefonia> grafo) {
        this.grafo = grafo;
    }
