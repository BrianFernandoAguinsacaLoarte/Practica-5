...
import vista.listas.tablas.ModeloTablaAdyacencias;
...
public class FrmMapa extends javax.swing.JDialog {
    ...
    private ModeloTablaAdyacencias mtady = new ModeloTablaAdyacencias();
    ...
    private void generarAdyacencias() {
        try {
    ...
    private void realizarAlgortimos() throws EmptyException, Exception {
        if ("Dijkstra".equals(cbxAlgoritmo.getSelectedItem().toString())) {
            ...
            //Obtengo las etiquetas de los vertices
    ...
    private void mostrarRecorridos() throws EmptyException, Exception {
        if ("Anchura".equals(cbxRecorrido.getSelectedItem().toString())) {
            ...
            JOptionPane.showMessageDialog(null, ed.getGrafoTelefonia().anchura(cbxOrigen.getSelectedIndex() + 1));
            ...
            JOptionPane.showMessageDialog(null, ed.getGrafoTelefonia().profundidad(1));
    ...
    private void initComponents() {
        ...
        labelRect1.setColorDeBorde(new java.awt.Color(51, 51, 51));
        labelRect1.setColorDeSegundoBorde(new java.awt.Color(51, 51, 51));
        ...
        labelRound1.setColorDeSegundoBorde(new java.awt.Color(51, 51, 51));
        panel1.add(labelRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 10, 890, 30));

        buttonRect2.setBackground(new java.awt.Color(0, 0, 0));
        ...
        buttonRect3.setBackground(new java.awt.Color(0, 0, 0));
        ...
        buttonRect4.setBackground(new java.awt.Color(0, 0, 0));
        ...
        buttonRect5.setBackground(new java.awt.Color(0, 0, 0));
        ...
        buttonRect6.setBackground(new java.awt.Color(0, 0, 0));
        ...
        labelRect3.setColorDeBorde(new java.awt.Color(51, 51, 51));
        labelRect3.setColorDeSegundoBorde(new java.awt.Color(51, 51, 51));
        ...
        labelRect4.setColorDeBorde(new java.awt.Color(51, 51, 51));
        labelRect4.setColorDeSegundoBorde(new java.awt.Color(51, 51, 51));
        ...
        btnMostrarRuta.setBackground(new java.awt.Color(0, 0, 0));
        ...
        btnMostrarRuta1.setBackground(new java.awt.Color(0, 0, 0));
